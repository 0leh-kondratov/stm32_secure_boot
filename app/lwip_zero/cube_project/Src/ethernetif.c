...
static void ethernetif_get_unique_mac(uint8_t mac[6]);
...
static void ethernetif_get_unique_mac(uint8_t mac[6])
{
  ...
  mac[0] = 0x02U;
  mac[1] = (uint8_t)((uid2 >> 8) & 0xFFU);
  mac[2] = (uint8_t)(uid2 & 0xFFU);
  mac[3] = (uint8_t)((uid1 >> 16) & 0xFFU);
  mac[4] = (uint8_t)((uid1 >> 8) & 0xFFU);
  mac[5] = (uint8_t)((uid0 ^ uid1 ^ uid2) & 0xFFU);
...
static void low_level_init(struct netif *netif)
{
  ...
  ethernetif_get_unique_mac(macaddress);
