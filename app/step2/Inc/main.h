...
/* I2C1: NUCLEO-H743ZI. Два варианта пинов (оба AF4, GPIOB):
 *   0 — PB6 SCL, PB7 SDA (Morpho)
 *   1 — PB8 SCL, PB9 SDA (разъём CN7: D15=SCL, D14=SDA — как на NUCLEO-F207ZG; на CN8 I2C не выведен) */
...
/* 1 = внутренние подтяжки SDA/SCL; 0 = без подтяжек (если на модуле уже есть). */
